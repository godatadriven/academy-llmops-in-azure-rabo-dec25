...
@tracer.start_as_current_span("extract_general_info")
...
@tracer.start_as_current_span("extract_business_category")
...
@tracer.start_as_current_span("extract_businesses_involved")
...
@tracer.start_as_current_span("extract_business_specific_info")
...
@tracer.start_as_current_span("extract_business_info")
...
@tracer.start_as_current_span("extract_article_info")
...
def extract_info_from_articles(
    ...
    for article in articles:
        try:
            ...
            article_info = None
            trace_id = trace.get_current_span().get_span_context().trace_id
            log_with_trace("error", json_payload={"error": str(e)}, trace_id=trace_id)
